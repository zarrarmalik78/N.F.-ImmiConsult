...
const Home: React.FC = () => {
  return (
    <div className="animate-fade-in relative">
          ...
          >
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex space-x-24 items-center">
                <span className="text-white/90 font-black text-xl md:text-2xl uppercase tracking-[0.3em]">Expert Document Checking</span>
                <span className="text-[#2563EB] font-black text-2xl">•</span>
                <span className="text-white/90 font-black text-xl md:text-2xl uppercase tracking-[0.3em]">Global Visa Experts</span>
                <span className="text-[#2563EB] font-black text-2xl">•</span>
                <span className="text-white/90 font-black text-xl md:text-2xl uppercase tracking-[0.3em]">Trusted by 5000+ Travelers</span>
                <span className="text-[#2563EB] font-black text-2xl">•</span>
                <span className="text-white/90 font-black text-xl md:text-2xl uppercase tracking-[0.3em]">98% Success Rate</span>
                <span className="text-[#2563EB] font-black text-2xl">•</span>
              </div>
            ))}
          </motion.div>
      ...
      {/* Simplified Why Choose Us */}
      <section className="py-32 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-24">
             <h2 className="text-5xl md:text-7xl font-black text-[#0F172A] tracking-tighter uppercase">Why <span className="text-[#2563EB]">Choose Us</span>?</h2>
             <p className="text-slate-500 text-lg font-medium mt-6">Expert guidance and support to make your visa journey simple and successful.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 auto-rows-[320px]">
            ...
            >
              ...
              <div className="relative z-10">
                <h4 className="text-4xl font-black text-[#0F172A] mb-4 tracking-tight">Careful Document Review</h4>
                <p className="text-slate-500 max-w-lg font-medium leading-relaxed">Our experts check every part of your file, including your bank statements and job papers, to make sure you have the best chance of approval.</p>
              </div>
            </motion.div>
            ...
            {REASONS.slice(0, 3).map((reason, idx) => (
              ...
              >
                ...
                <h4 className="text-2xl font-black text-[#0F172A] mb-4 tracking-tight uppercase">{reason.title}</h4>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center text-white">
          ...
          >
            <h2 className="text-5xl md:text-8xl font-black max-w-5xl mx-auto leading-[0.9] tracking-tighter uppercase">Your Travel <br/> Starts Here.</h2>
            <p className="text-blue-100/60 text-xl font-medium max-w-2xl mx-auto uppercase tracking-widest">Start your application today.</p>
