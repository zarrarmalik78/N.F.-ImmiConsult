        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          <div className="w-full lg:w-3/5 text-center lg:text-left">
            ...
            >
              ...
              <span className="text-[8px] md:text-[10px] font-black text-[#0F172A] uppercase tracking-[0.2em]">Pakistan's Trusted Visa Experts</span>
            </motion.div>
            ...
            >
              Focus on the Journey, Not the Paperwork. Your trusted experts for easy and successful travel.
            </motion.p>
            ...
            >
              ...
              >
                <span>Check Your Visa Chances</span>
              ...
              <div className="flex items-center space-x-4">
                 ...
                 <div className="text-left">
                    <p className="text-[#0F172A] font-black leading-none text-xs md:text-sm">98% Success</p>
                    <p className="text-slate-400 text-[10px] font-bold uppercase tracking-wider">Proven Results</p>
                 </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="relative max-w-sm mx-auto lg:max-w-none">
               ...
               >
                 <img src="https://img.freepik.com/free-photo/visa-application-composition-with-europe-america-flag_23-2149117811.jpg?t=st=1768858344~exp=1768861944~hmac=8efeb759f9fccfc62655ac94dc16d78fa87fa762fd0ac75235a346db2327c7d1&w=1060" alt="Travel Visa" className="h-[300px] md:h-[500px] w-full object-cover" />
               ...
               <div className="absolute -top-6 -right-4 md:-top-10 md:-right-8 w-20 h-20 md:w-28 md:h-28 bg-[#0F172A] rounded-2xl md:rounded-3xl flex flex-col items-center justify-center text-white rotate-12 shadow-2xl z-20">
                  ...
                  <span className="text-[6px] md:text-[8px] font-black uppercase tracking-[0.2em]">Approval</span>
               </div>
               ...
               >
                  ...
                  <div className="flex flex-col border-l border-slate-100 pl-4 md:pl-6">
                    <p className="text-[#0F172A] font-black leading-none text-xs md:text-base uppercase tracking-tight">Happy Clients</p>
                    <p className="text-[#2563EB] text-[9px] md:text-[11px] font-black uppercase tracking-widest mt-1">5000+ Visas</p>
                  </div>
               </motion.div>
            </div>
          </motion.div>
